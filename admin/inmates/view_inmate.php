...
if (isset($_GET['id']) && $_GET['id'] > 0) {
    ...
    if (isset($cell_id) && isset($prison_id)) {
        ...
        $prison_name = $prison['name'] . $cell['name'];
    }
}
                    ...
                    <div class=""><b>Inmate's Status:</b>
                        ...
                        <?php else : ?>
                            ...
                            <?php elseif (isset($status) && $status == 2) : ?>
                                <span class='text-warning'>On Remand</span>
                            <?php else : ?>
        ...
        <div class="card rounded-0 shadow">
            <div class="card-body">
                <div class="container-fluid" id="inmate-details">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-10 col-md-9 col-sm-12 col-xs-12">
                            <div class="d-flex w-100">
                                ...
                                <div class="col-auto m-0 border flex-shrink-1 flex-grow-1"><?= isset($prison_name) ? $prison_name : '' ?></div>
                            </div>
                            <div class="d-flex w-100">
                            ...
                            <div class="d-flex w-100">
                                <div class="col-auto m-0 border bg-gradient-secondary">Country</div>
                                <div class="col-auto m-0 border flex-shrink-1 flex-grow-1"><?= isset($country) ? $country : '' ?></div>
                            </div>
                            <div class="d-flex w-100">
                            ...
                            <div class="d-flex w-100">
                                <div class="col-auto m-0 border bg-gradient-secondary">Illness</div>
                                <div class="col-auto m-0 border flex-shrink-1 flex-grow-1"><?= isset($illness) ? $illness : '' ?></div>
                    ...
                    <?php if ($status != 2) : ?>
                        <fieldset class="border px-2 pb-2">
                            ...
                            <div class="d-flex w-100">
                                ...
                                <div class="col-auto m-0 border flex-shrink-1 flex-grow-1"><?= isset($sentence) ? $sentence . " " . $duration : '' ?></div>
                            </div>
                            <div class="d-flex w-100">
                    ...
                    <?php else : ?>
                        <fieldset class="border px-2 pb-2">
                            <legend class="w-auto mx-3 px-2">Remand Details</legend>

                            <div class="d-flex w-100">
                                <div class="col-auto m-0 border bg-gradient-secondary">Remand time starts</div>
                                <div class="col-auto m-0 border flex-shrink-1 flex-grow-1"><?= isset($date_from) ? date("M d, Y", strtotime($date_from)) : '' ?></div>
                    ...
                    <?php endif ?>
                    <fieldset class="border px-2 pb-2">
                        <legend class="w-auto mx-3 px-2">Next of kin </legend>
                        <div class="d-flex w-100">
                            <div class="col-auto m-0 border bg-gradient-secondary">Name</div>
