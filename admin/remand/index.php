...
$qry = $conn->query("SELECT *,concat(lastname,', ', firstname, coalesce(concat(' ', middlename), '')) as `name` from `inmate_list` where status='2' order by `name` asc ");
...
<div class="card card-outline rounded-0 card-navy">
    <div class="card-header">
        <h3 class="card-title">Inmates on remand</h3>
        <?php //echo '<br />' . $count; 
        ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php else : ?>
                                    <?php if ($row['status'] == 2) : ?>
                                        <span class="badge badge-success bg-gradient-success px-3 rounded-pill">Remand</span>
                                    <?php else : ?>
